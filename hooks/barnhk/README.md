...
无需安装任何外部依赖。PowerShell 5.1+（Windows 10 内置）即可运行。
...
配置编辑：
- Unix: `~/.claude/hooks/barnhk/lib/barnhk.conf`
- Windows: `%USERPROFILE%\.claude\plugins\cache\cckit\barnhk\<version>\lib\barnhk.psd1`
